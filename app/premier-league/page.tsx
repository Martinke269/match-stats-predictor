...
export default function PremierLeaguePage() {
  ...
  // Match schedule from the user's image - Kampdag 25 af 38
  const matchSchedule = [
    { match: 'Leicester vs Nottingham Forest', day: 'Fredag', time: '21:00' },
    { match: 'Man Utd vs Tottenham', day: 'Lørdag', time: '13:30' },
    { match: 'Fulham vs Everton', day: 'Lørdag', time: '16:00' },
    { match: 'Bournemouth vs West Ham', day: 'Lørdag', time: '16:00' },
    { match: 'Arsenal vs Southampton', day: 'Lørdag', time: '16:00' },
    { match: 'Wolves vs Chelsea', day: 'Lørdag', time: '16:00' },
    { match: 'Ipswich vs Aston Villa', day: 'Lørdag', time: '16:00' },
    { match: 'Newcastle vs Brentford', day: 'Lørdag', time: '18:30' },
    { match: 'Brighton vs Crystal Palace', day: 'Søndag', time: '15:00' },
    { match: 'Liverpool vs Man City', day: 'Søndag', time: '17:30' }
  ];
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-5xl font-bold text-white">Premier League</h1>
            </div>
